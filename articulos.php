...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (isset($_GET['id'])) {      
      $sql = $conexion->prepare("SELECT primer_apellido, edad FROM datos_identificacion where id_tarjeta=:id");
      ...
      $sql = $conexion->prepare("SELECT primer_apellido, edad FROM datos_identificacion");
      $sql->execute();
