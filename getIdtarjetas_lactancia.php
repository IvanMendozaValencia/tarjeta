...
$sql = "SELECT  datos_identificacion.id_tarjeta  FROM periodo_lactancia INNER JOIN datos_identificacion ON id_tarjeta =fk_id_tarjeta WHERE id_tarjeta = $id LIMIT 1";
