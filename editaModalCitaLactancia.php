...
<div class="modal fade" id="editaModalCitaLactancia" tabindex="-1" aria-labelledby="editaModalCitaLactanciaLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editaModalCitaLactanciaLabel">Editar Cita Lactancia</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>        
                <div class="modal-body">
                <form action="actualizaCitaLactancia.php" method="post" enctype="multipart/form-data">
