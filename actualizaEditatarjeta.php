...
servicio = '$servicio', 
folio = '$folio', 
nombre_pre_ser = '$nombre_pre_ser', 
curp_pre_ser = '$curp_pre_ser', 
curp = '$curp', 
nombre = '$nombre', 
...
peso_ant_emb = '$peso_ant_emb', 
peso_emb = '$peso_emb', 
talla = '$talla', 
imc = '$imc',
afromexicana = '$afromexicana', 
migragrante = '$migragrante', 
nacional = '$nacional', 
internacional = '$internacional', 
indigena = '$indigena', 
lengua_indigena = '$lengua_indigena', 
lengua_habla = '$lengua_habla', 
habla_espanol = '$habla_espanol', 
calle = '$calle', 
...
localidad = '$localidad',
telefono = '$telefono', 
ap_personal_comunitario = '$ap_personal_comunitario',
ap_fecha = '$ap_fecha', 
ap_trimestre = '$ap_trimestre', 
ap_puerperio = '$ap_puerperio', 
ap_lactancia = '$ap_lactancia', 
ap_prueba_serologica_embarazo = '$ap_prueba_serologica_embarazo', 
ap_se_ignora = '$ap_se_ignora', 
ap_ulima_mestruacion = '$ap_ulima_mestruacion', 
ap_confiable = '$ap_confiable', 
ap_fecha_ultrasonido_obstretico = '$ap_fecha_ultrasonido_obstretico', 
ap_semana_gestacion_usg = '$ap_semana_gestacion_usg', 
ap_fecha_probable_parto = '$ap_fecha_probable_parto', 
af_ninguno = '$af_ninguno', 
af_tuberculosis = '$af_tuberculosis', 
af_hipertencion = '$af_hipertencion',  
af_diabetes = '$af_diabetes', 
af_ef_hiper_embarazo = '$af_ef_hiper_embarazo',
af_otro = '$af_otro',
af_otro_especifique = '$af_otro_especifique',
app_ninguno = '$app_ninguno', 
app_diabetes_geostacional = '$app_diabetes_geostacional',
app_diabetes = '$app_diabetes', 
app_hipertencio_arterial = '$app_hipertencio_arterial', 
app_preeclampsia_enclampsia = '$app_preeclampsia_enclampsia', 
app_nefropatia = '$app_nefropatia', 
app_cardiopatia = '$app_cardiopatia', 
app_hemorragia_obstetrica = '$app_hemorragia_obstetrica', 
app_padecimiento_oncologico = '$app_padecimiento_oncologico',
app_b24x = '$app_b24x',
app_a539 = '$app_a539',
app_enfermedad_trnas_vector = '$app_enfermedad_trnas_vector',
app_tuberculosis = '$app_tuberculosis',
app_sars_cov2 = '$app_sars_cov2',
app_otro_antecedente = '$app_otro_antecedente',
app_grupo_sanguinieo = '$app_grupo_sanguinieo', 
app_rh = '$app_rh', 
app_prueba_coombs = '$app_prueba_coombs', 
app_tratamiento = '$app_tratamiento',
de_violencia_fam = '$de_violencia_fam',
devf_b24x_fecha_inmuno = '$devf_b24x_fecha_inmuno',
devf_b24x_imnuno = '$devf_b24x_imnuno',
devf_b24x_fecha_enzimo = '$devf_b24x_fecha_enzimo',
devf_b24x_enzimo = '$devf_b24x_enzimo',
devf_a539_fecha_inmuno = '$devf_a539_fecha_inmuno',
devf_a539_imnuno = '$devf_a539_imnuno', 
devf_a539_fecha_enzimo = '$devf_a539_fecha_enzimo', 
devf_a539_enzimo = '$devf_a539_enzimo', 
de_depresion_prenatal = '$de_depresion_prenatal',
dedp_b24x_fecha_rapida = '$dedp_b24x_fecha_rapida', 
dedp_b24x_rapida = '$dedp_b24x_rapida', 
dedp_b24x_fecha_lab = '$dedp_b24x_fecha_lab',
dedp_b24x_lab = '$dedp_b24x_lab', 
dedp_a539_fecha_rapidaa = '$dedp_a539_fecha_rapidaa',
dedp_a539_rapida = '$dedp_a539_rapida', 
dedp_a539_fecha_lab = '$dedp_a539_fecha_lab', 
dedp_a539_lab = '$dedp_a539_lab', 
ag_atencio_preges = '$ag_atencio_preges',
ag_riesgos = '$ag_riesgos',
ag_gestas = '$ag_gestas', 
ag_partos = '$ag_partos',
ag_cesarias = '$ag_cesarias',
ag_abortos = '$ag_abortos', 
ag_ectopico = '$ag_ectopico',
ag_mola = '$ag_mola', 
ag_emb_mul = '$ag_emb_mul', 
ag_hijos_nac_viv = '$ag_hijos_nac_viv', 
ag_ag_hijos_nac_mue = '$ag_ag_hijos_nac_mue', 
ag_resol_ult_emba = '$ag_resol_ult_emba', 
ag_resol_fecha_ul_emb = '$ag_resol_fecha_ul_emb', 
ag_uso_prev_antico_tipo = '$ag_uso_prev_antico_tipo', 
ag_uso_prev_antico_tiempo_uso = '$ag_uso_prev_antico_tiempo_uso', 
ag_uso_prev_fecha_suspe = '$ag_uso_prev_fecha_suspe',
ag_uso_prev_falla = '$ag_uso_prev_falla',
ag_otro_ante_ginecoobs = '$ag_otro_ante_ginecoobs',
ag_otro_ante_ginecoobs_esp = '$ag_otro_ante_ginecoobs_esp',
bio_fecha_td_primera = '$bio_fecha_td_primera', 
bio_fecha_td_segunda = '$bio_fecha_td_segunda',
bio_fecha_td_tercera = '$bio_fecha_td_tercera',
bio_fecha_tdpa = '$bio_fecha_tdpa',
bio_fecha_influenza = '$bio_fecha_influenza',
bio_fecha_covid19 = '$bio_fecha_covid19', 
adicciones = '$adicciones',
adic_tabaco = '$adic_tabaco', 
adic_antidepre = '$adic_antidepre',
adic_alcohol = '$adic_alcohol', 
adic_ansioliticos = '$adic_ansioliticos',
adic_otros = '$adic_otros', 
adic_consumo_act = '$adic_consumo_act', 
adic_años = '$adic_años', 
adic_meses = '$adic_meses', 
sbde_rev_odont = '$sbde_rev_odont',
sbde_atn_caries = '$sbde_atn_caries',
sbde_atn_periodonitis = '$sbde_atn_periodonitis', 
sbde_atn_otro = '$sbde_atn_otro', 
v_nuticional = '$v_nuticional', 
pc_lab_otr_b24x_fecha = '$pc_lab_otr_b24x_fecha',
pc_lab_otr_b24x_detectable = '$pc_lab_otr_b24x_detectable',
pc_lab_otr_a539_fecha = '$pc_lab_otr_a539_fecha',
pc_lab_otr_a539_posneg = '$pc_lab_otr_a539_posneg', 
cdg_fecha = '$cdg_fecha',
cdg_ayuno = '$cdg_ayuno', 
cdg_60 = '$cdg_60', 
cdg_120 = '$cdg_120'
