...
<body class="d-flex flex-column h-100">
    ...
    <div class="container py-3">
        ...
        <div class="row justify-content-end">
            <div class="col-auto">             
                <a href="../salud/registrostarjeta.php" class="btn btn-secondary" ></i>Citas Prenatales</a>
       ...
       <p>Modal body text goes here.</p>
        ...
        <input type="hidden" name="id_tarjeta" id="id_tarjeta" class="form-control" value="<?php echo $fila['id_tarjeta']; ?>" >      
        ...
        <!----INICIO---->
        <center><div class="bg-secondary p-2 text-white bg-opacity-90 modal-title fs-5">DATOS DE IDENTIFICACIÓN</div>
        </center>
                ...
                <div class="row justify-content-start text-start ">
                    ...
                    <label for="lengua_habla" class="form-label">CUÁL LENGUA INDÍGENA HABLA:</label>
                        <select id="lengua_habla" name="lengua_habla" class="form-select" required>
                        <option value="">Seleccionar</option>
                        <option value="TU UN SAVI" <?php if('TU UN SAVI' == $rowcita['lengua_habla']) { echo 'selected'; } ?>>TU UN SAVI</option>
                        <option value="NÁHUATL" <?php if('NÁHUATL' == $rowcita['lengua_habla']) { echo 'selected'; } ?>>NÁHUATL</option>
                        <option value="AMUZGO" <?php if('AMUZGO' == $rowcita['lengua_habla']) { echo 'selected'; } ?>>AMUZGO</option>
                        <option value="ME PHAA" <?php if('ME PHAA' == $rowcita['lengua_habla']) { echo 'selected'; } ?>>ME PHAA</option>
                        </select>                      
                    </div>
        ...
        <!----INICIO---->
        <center> <div class="bg-secondary p-2 text-white bg-opacity-90 modal-title fs-5">ANTECEDENTES PERSONALES PATOLOGICOS</div></center>
                     <div class="container-fluid p-2 text-center">
                    <div class="row justify-content-start text-start ">  
        ...
        <!----INICIO---->
        <center> <div class="bg-secondary p-2 text-white bg-opacity-90 modal-title fs-5">DETECCIONES EN EL EMBARAZO</div></center>
        ...
        <!----INICIO---->
        <center> <div class="bg-secondary p-2 text-white bg-opacity-90 modal-title fs-5">ANTECEDENTES GINECOOBSTÉTRICOS</div></center>
                <div class="container-fluid p-2 text-center">
                <div class="row justify-content-start text-start "> 
        ...
        <!----INICIO---->
        <center> <div class="bg-secondary p-2 text-white bg-opacity-90 modal-title fs-5">BIOLÓGICOS FECHA DE APLICACIÓN</div></center>
                <div class="container-fluid p-2 text-center">
                <div class="row justify-content-start text-start ">
